package com.demo.framework.restapis.hibernate;
...
@CrossOrigin
@EnableJpaRepositories(basePackages={"com.demo.framework.restapis.repository"})
public class Config {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { ENTITY_MANAGER_PACKAGE_TO_SCAN});
